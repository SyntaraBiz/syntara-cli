import type { AstroIntegration, AstroBuildDoneParams } from "./astro-types.js";
import type { SyntaraAstroOptions } from "./types.js";
import { createSitemapHook } from "./sitemap.js";
import { createSeoHook } from "./seo.js";
import { createCloudflareHook } from "./cloudflare.js";

export type { SyntaraAstroOptions } from "./types.js";
export type { AstroIntegration } from "./astro-types.js";

export default function syntara(options: SyntaraAstroOptions = {}): AstroIntegration {
  ...
  return {
    ...
    hooks: {
      "astro:build:done": async (hookOptions) => {
        ...
        logger.info(
          `@syntara/astro: Build completed with ${pages.length} pages`,
        );
      },
